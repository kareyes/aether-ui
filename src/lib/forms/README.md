...
```bash
# The forms module is included in aether-ui
pnpm add aether-ui effect
```
...
import { withField, withFormLayout } from "aether-ui/forms";
...
```typescript
import { FormController } from "aether-ui/forms";
...
```svelte
<script lang="ts">
  import { SchemaForm } from "aether-ui/forms";
...
<script lang="ts">
  ...
  import { FormController, SchemaForm } from "aether-ui/forms";
...
```typescript
import { RequiredCheckbox, requiredCheckbox } from "aether-ui/forms";
...
```typescript
import { RequiredSwitch, requiredSwitch } from "aether-ui/forms";
...
```typescript
import { RequiredFile, requiredFile } from "aether-ui/forms";
